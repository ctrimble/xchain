 ...
 */
public class TestFilterChooseCommand
{
  public static String CATALOG_URI = "resource://context-class-loader/org/xchain/namespaces/core/filter-choose-command.xchain";
  ...
  private static final String TEST_NAMESPACE = "different-name";
