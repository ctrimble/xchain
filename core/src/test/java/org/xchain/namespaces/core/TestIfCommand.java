...
{
  public static String CATALOG_URI = "resource://context-class-loader/org/xchain/namespaces/core/if-command.xchain";
  public static String XCHAIN_NAMESPACE_URI = "http://www.xchain.org/core/1.0";
  public static QName TOP_LEVEL_IF_TRUE_COMMAND = new QName(XCHAIN_NAMESPACE_URI, "top-level-if-true");
  public static QName TOP_LEVEL_IF_FALSE_COMMAND = new QName(XCHAIN_NAMESPACE_URI, "top-level-if-false");
...
**/
  ...
  @Test public void testTopLevelIfTrue()
    throws Exception
  {
    // get the command.
    Command command = catalog.getCommand(TOP_LEVEL_IF_TRUE_COMMAND);
    ...
    assertEquals("A namespace set on the current tag was not correct.", Boolean.TRUE, value);
  }

  @Test public void testTopLevelIfFalse()
    throws Exception
  {
    Command command = catalog.getCommand(TOP_LEVEL_IF_FALSE_COMMAND);
    ...
    assertEquals("A namespace set on the current tag was not correct.", Boolean.FALSE, value);
  }
}
