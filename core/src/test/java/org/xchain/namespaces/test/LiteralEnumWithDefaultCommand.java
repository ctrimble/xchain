 ...
 * @author Josh Kennedy
 */
@Element(localName="literal-enum-with-default")
public abstract class LiteralEnumWithDefaultCommand
  implements Command
{
  ...
  @Attribute(localName="value", type=AttributeType.LITERAL, defaultValue="FIRST")
