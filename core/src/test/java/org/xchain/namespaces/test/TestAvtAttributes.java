 ...
 */
public class TestAvtAttributes
{
  public static String CATALOG_URI = "resource://context-class-loader/org/xchain/namespaces/test/avt-attributes.xchain";
  ...
  /**
   * Tests an avt enumeration with its first value.
   */
  ...
  /**
   * Tests an avt enumeration with its second value.
   */
  ...
  /**
   * Tests an avt enumeration with its default value.
   */
  ...
  /**
   * Tests an avt enumeration without a value.
   */
