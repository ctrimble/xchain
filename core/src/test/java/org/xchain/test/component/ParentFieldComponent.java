...
/**
 * Parent class for a component.  The field definitions should be inherited.
 * @author Devon Tackett
 */
public class ParentFieldComponent {
  ...
  public String publicResult = "initial";
  
  @In(select="$protected-field")
  protected String protectedResult = "initial";  
}
