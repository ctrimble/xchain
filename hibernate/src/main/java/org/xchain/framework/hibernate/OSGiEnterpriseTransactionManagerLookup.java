...
/**
 * Enables lookup up of the TransactionManager in an OSGi Enterprise environment.
 *  
 * @author John Trimble
 */
public class OSGiEnterpriseTransactionManagerLookup extends JNDITransactionManagerLookup {
